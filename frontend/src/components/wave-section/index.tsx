            ...
            <div className="wave-wrapper">
                ...
                <div className="wave-top">
                    <div className="wave-top-container">
                        <svg width="100%" height="100%" id="svg" fill="#202020" viewBox="0 0 1440 300" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg" className="wave-svg transition duration-300 ease-in-out delay-150"><path d="M 0,400 L 0,150 C 100.59330143540669,168.56459330143542 201.18660287081337,187.12918660287082 296,194 C 390.8133971291866,200.87081339712918 479.8468899521532,196.04784688995215 575,181 C 670.1531100478468,165.95215311004785 771.425837320574,140.6794258373206 879,125 C 986.574162679426,109.32057416267942 1100.4497607655503,103.23444976076556 1195,109 C 1289.5502392344497,114.76555023923444 1364.7751196172248,132.38277511961724 1440,150 L 1440,400 L 0,400 Z" stroke="none" stroke-width="0" fill-opacity="1" className="transition-all duration-300 ease-in-out delay-150 path-0"></path></svg>
                    </div>
                </div>
